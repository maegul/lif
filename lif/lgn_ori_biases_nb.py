...
fig = px.line(
    ...
    range_y=[0, 1], labels={'x': 'von mises k', 'y': 'circ var'}
    )
...
a, b = cvvm.von_mises(0, k=k_val), cvvm.von_mises(np.pi/2, k=k_val)
a, b
# -----------
# ===========
target_amp = (a + b)/2
...
# -----------
# ===========
circ_var = cv(spat_resp, angles.rad)
circ_var
# -----------
# ===========
k_cv(circ_var)
...
reload(ff)
# -----------
sf.parameters.mk_ori_biased_duplicate()
# ===========
...
# -----------
# ===========
plot.orientation_plot(sf.mk_ori_biased_parameters(0.3), SpatFrequency(7)).show()
# -----------
# ===========
plot.ori_spat_freq_heatmap(sf.mk_ori_biased_parameters(0.3), n_orientations=16).show()
# -----------
# ===========
