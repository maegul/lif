...
# -
# +
results_base_dir = Path('/home/ubuntu/lif_hws/work/results_data')
# -
...
# ## Run prototype
# +
sim_meta_data = do.SimulationMetaData(
	exp_id = 'HWS3',
	comments = 'Orientation Tuning at preferred Spatial Freq'
	)
# -
# +
print(mk_time())
# -
# +
results_dir = results_base_dir / sim_meta_data.exp_id
if results_dir.exists():
	print(f'Results Dir {results_dir} exists ... using existing directory')

exp_meta_data_path = results_dir / 'sim_meta_data.pkl'
if not exp_meta_data_path.exists():
	run._save_pickle_file(exp_meta_data_path, sim_meta_data)
# -
# +
print('Running simulation')
if 'parallel_params' in locals():
